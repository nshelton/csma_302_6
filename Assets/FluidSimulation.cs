...
public class FluidSimulation : MonoBehaviour
{
    ...
    [SerializeField, Range(1, 30)] public float _distanceThreshold;
    [SerializeField, Range(0, 1)] public float _decay;
    [SerializeField, Range(0, 45)] public float _velocityScale;
    ...
    void DispatchKernel(string name, RenderTexture sourceFluid = null, RenderTexture destinationFluid = null, RenderTexture sourceDivergence = null, RenderTexture destinationDivergence = null, RenderTexture sourcePressure = null, RenderTexture destinationPressure = null)
    {
    ...
    void Update()
    {
        ...
        _simulationShader.SetFloat("_distanceThresh", _distanceThreshold);
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            _simulationShader.SetVector("_mouseVel", _velocityScale * (Input.mousePosition - _lastFramePos));

            DispatchKernel("Force", destinationFluid: _fluidA);
        }

        _lastFramePos = Vector3.Lerp(_lastFramePos, Input.mousePosition, 0.5f);
        ...
        {
            DispatchKernel("Pressure", sourcePressure: _pressureA, sourceDivergence: _divergence, destinationPressure: _pressureB);
            DispatchKernel("Pressure", sourcePressure: _pressureB, sourceDivergence: _divergence, destinationPressure: _pressureA);
        }
